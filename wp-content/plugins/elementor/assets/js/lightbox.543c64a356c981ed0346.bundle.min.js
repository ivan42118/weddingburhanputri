      ...
      e.exports = elementorModules.ViewModule.extend({
        ...
        showModal: function (e) {
          ...
          switch (
            ...
            case "image":
              ...
              e.slideshow = { slides: i, swiper: { loop: !1, pagination: !1 } };
            case "slideshow":
        ...
        setVideoContent: function (e) {
          ...
          if ("hosted" === e.videoType) {
            ...
            let i = elementorFrontend.utils.baseVideoLoader;
          ...
          s.append(n), n.append(l), o.setMessage(s), this.setVideoAspectRatio();
          const a = o.onHide;
          o.onHide = function () {
            a(),
              (this.$buttons = jQuery()),
        ...
        getShareLinks: function () {
          const { i18n: e } = elementorFrontend.config,
            ...
            o = i("<div>", { class: s.slideshow.shareLinks }),
            l = this.getSlide("active"),
            a = l.find(n.image),
            r = l.data("elementor-slideshow-video");
          let d;
          return (
            (d = r || a.attr("src")),
            i.each(t, (e, t) => {
              ...
              s.prepend(i("<i>", { class: "eicon-" + e })), o.append(s);
            }),
            r ||
              o.append(
                i("<a>", { href: d, download: "" })
        ...
        createShareLink: function (e, t) {
          const i = {};
          if ("pinterest" === e) i.image = encodeURIComponent(t);
          else {
            const e = elementorFrontend.utils.urlActions.createActionHash(
              "lightbox",
              { id: this.id, url: t }
            );
            i.url = encodeURIComponent(location.href.replace(/#.*/, "")) + e;
          }
          return ShareLink.getNetworkLink(e, i);
        },
          ...
          if (i || s || n || o) {
            if (
              ...
              i.on("click", (e) => {
                ...
                (r.$shareMenu = t("<div>", { class: a.shareMenu }).append(i)),
                r.$iconShare
                  .add(r.$shareMenu)
                  .on("click", this.toggleShareMenu),
                r.$header.append(r.$iconShare, r.$shareMenu),
                (this.$buttons = this.$buttons.add(r.$iconShare));
            }
            return (
              n &&
                ((r.$iconZoom = t("<i>", {
                ...
                r.$iconZoom.on("click", this.toggleZoomMode),
                r.$header.append(r.$iconZoom),
                (this.$buttons = this.$buttons.add(r.$iconZoom))),
              s &&
                ((r.$iconExpand = t("<i>", {
                  class: a.iconExpand,
                  role: "switch",
                ...
                r.$iconExpand.on("click", this.toggleFullscreen),
                r.$header.append(r.$iconExpand),
                (this.$buttons = this.$buttons.add(r.$iconExpand))),
              i &&
                ((r.$counter = t("<span>", { class: a.counter })),
                r.$header.append(r.$counter)),
              r.$header
            );
          }
        },
        ...
        getSlideshowFooter: function () {
          const e = jQuery,
            ...
            s = e("<div>", { class: t.slideshow.title }),
        ...
        setSlideshowContent: function (e) {
          const { i18n: t } = elementorFrontend.config,
            ...
            r = a.slideshow,
            d = i("<div>", { class: r.container }),
            c = i("<div>", { class: r.slidesWrapper });
          let h, u;
          e.slides.forEach((e) => {
            let s = r.slide + " " + a.item;
            e.video && (s += " " + a.video);
            const n = i("<div>", { class: s });
            if (e.video) {
              n.attr("data-elementor-slideshow-video", e.video);
              const s = i("<div>", { class: a.playButton }).html(
                i("<i>", { class: a.playButtonIcon, "aria-label": t.playVideo })
              );
              n.append(s);
            } else {
            ...
            s ||
              ((h = i("<div>", {
                class: r.prevButton + " " + a.preventClose,
                "aria-label": t.previous,
              }).html(i("<i>", { class: r.prevButtonIcon }))),
              (u = i("<div>", {
                class: r.nextButton + " " + a.preventClose,
                "aria-label": t.next,
              }).html(i("<i>", { class: r.nextButtonIcon }))),
              d.append(u, h),
          ...
          m.onShow = async () => {
            p();
            const t = {
              pagination: { el: "." + r.counter, type: "fraction" },
            ...
            s || (t.navigation = { prevEl: h, nextEl: u }),
        ...
        setVideoAspectRatio: function (e) {
          ...
          const t = this.getModal().getElements("widgetContent"),
            ...
            s = this.getSettings("classes.aspectRatio");
          (this.oldAspectRatio = e),
            i && t.removeClass(s.replace("%s", i)),
            e && t.addClass(s.replace("%s", e));
        },
        getSlide: function (e) {
        ...
        playSlideVideo: function () {
          ...
          const i = this.getSettings("classes"),
            ...
            n = jQuery("<div>", { class: i.videoWrapper }),
            o = e.children("." + i.playButton);
          let l, a;
          s.append(n),
            e.append(s),
          ...
          a.onApiReady((e) => {
            "youtube" === l
              ? this.prepareYTVideo(e, r, s, n, o)
              : "vimeo" === l && this.prepareVimeoVideo(e, r, s, n, o);
          }),
            o.addClass(i.playing).removeClass(i.hidden);
        },
        prepareYTVideo: function (e, t, i, s, n) {
        ...
        prepareVimeoVideo: function (e, t, i, s, n) {
          const o = this.getSettings("classes"),
            l = { id: t, autoplay: !0, transparent: !1, playsinline: !1 };
          (this.player = new e.Player(s, l)),
        ...
        openSlideshow: function (e, t) {
          ...
          i.each(function () {
            ...
            this.showModal({
              ...
              slideshow: { slides: s, swiper: { initialSlide: +n } },
            });
        },
      ...
      (t =
        ...
        (s = (function () {
          for (
            ...
            if ((e = i[s]) && e[1] in t) {
              var l = e.length;
              for (s = 0; s < l; s++) o[i[0][s]] = e[s];
              return o;
            }
          return !1;
        })()),
        (n = { change: s.fullscreenchange, error: s.fullscreenerror }),
        (o = {
          request: function (e) {
            return new Promise(
              function (i, n) {
